...
1. 分析目标代码，按 references/card-types.md 拆卡：总卡先行，子卡 3~8 张，总张数 4~9。卡片读者是没读过代码的人：要点写机制不写符号清单，规则见 references/style-rules.md C12~C14。
2. 卡片写入 <工作目录>/.temp/cardify/<主题>.md；格式与硬约束见 references/style-rules.md，参照 references/examples.md 的正例。
